        ...
        <div className="grid grid-cols-4 justify-center items-center w-full ">
          <div className="">
            <Link className="flex items-center flex-col" href={"#"} >
              ...
              <span className="text-[#efc99d]">Recharge</span>
            </Link>
          </div>
          <div className="">
            <Link className="flex items-center flex-col" href={"#"} >
              ...
              <span className="text-[#efc99d]">Withdraw</span>
            </Link>
          </div>
          <div className="">
            <Link className="flex items-center flex-col" href={"#"} >
              ...
              <span className="text-[#efc99d]">Help</span>
            </Link>
          </div>
          <div className="">
            <Link className="flex items-center flex-col" href={"#"} >
              ...
              <span className="text-[#efc99d]">Team</span>
            </Link>
          </div>
        </div>
        <div className="grid grid-cols-4 justify-center items-center w-full ">
          <div className="">
            <Link className="flex items-center flex-col" href={"#"} >
              ...
              <span className="text-[#efc99d]">Download APP</span>
            </Link>
          </div>
          <div className="">
            <Link className="flex items-center flex-col" href={"#"} >
              ...
              <span className="text-[#efc99d]">Activity</span>
            </Link>
          </div>
          <div className="">
            <Link className="flex items-center flex-col" href={"#"} >
              ...
              <span className="text-[#efc99d]">Agent Cooperation</span>
            </Link>
          </div>
          <div className="">
            <Link className="flex items-center flex-col" href={"#"} >
              ...
              <span className="text-[#efc99d]">Invite Friends</span>
            </Link>
          </div>
        </div>
      </div>
